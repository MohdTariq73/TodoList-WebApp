...
const populateTodos = () => {
    ...
    todoCheckboxes.forEach((element) => {
        element.addEventListener("click", (e) => {
            if (e.target.checked) {
                ...
                // slect this todo from todos array and update the todos array to set this todos isCompleted attribute as false
                todos = todos.map(todo => {
                    if (todo.id == element.parentNode.id) {
    ...
    // check the clear completed button click
